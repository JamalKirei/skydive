        ...
        <header className="bg-primary-gradient">
            <div className="container pt-4 pt-xl-5">
                ...
                <div className="col-12 col-lg-10 mx-auto">
                    ...
                    <div style={{"position":"relative","-webkit-flex":"0 0 45%","-ms-flex":"0 0 45%","flex":"0 0 45%","-webkit-transform":"translate3d(-15%, 35%, 0)","-ms-transform":"translate3d(-15%, 35%, 0)","transform":"translate3d(-15%, 35%, 0)"}}><Image  height={384} width={483} alt="not here" className="img-fluid" data-bss-parallax data-bss-parallax-speed="0.8" src="/assets/img/products/about_video_bg-copyright.png" /></div>
                    <div style={{"position":"relative","-webkit-flex":"0 0 45%","-ms-flex":"0 0 45%","flex":"0 0 45%","-webkit-transform":"translate3d(-5%, 20%, 0)","-ms-transform":"translate3d(-5%, 20%, 0)","transform":"translate3d(-5%, 20%, 0)"}}><Image width={484} height={322}   alt="not here" className="img-fluid" data-bss-parallax data-bss-parallax-speed="0.4" src="/assets/img/products/image-25-copyright.jpg" /></div>
                    <div style={{"position":"relative","-webkit-flex":"0 0 60%","-ms-flex":"0 0 60%","flex":"0 0 60%","-webkit-transform":"translate3d(0, 0%, 0)","-ms-transform":"translate3d(0, 0%, 0)","transform":"translate3d(0, 0%, 0)"}}><Image  alt="not here" height={430} width={645} className="img-fluid" data-bss-parallax data-bss-parallax-speed="0.25" src="/assets/img/products/image-28-copyright.jpg" /></div>
                    </div>
                </div>
                </div>
            </div>

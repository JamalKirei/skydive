      ...
      <section className="py-5">
        <div className="container py-5">
            ...
            <div className="col mb-4">
                <div><a href="#"><Image  alt="not here"  className="rounded img-fluid shadow w-100 fit-cover" src="/assets/img/image-9-copyright-370x240.jpg" width={446} height={250} style={{"height":"250px"}} /></a>
            ...
            <div className="col mb-4">
                <div><a href="#"><Image alt="not here"  className="rounded img-fluid shadow w-100 fit-cover" src="/assets/img/image-16-copyright-370x240.jpg" width={446} height={250} style={{"height":"250px"}} /></a>
